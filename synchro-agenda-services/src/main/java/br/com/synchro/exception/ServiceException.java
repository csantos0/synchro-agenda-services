...
public class ServiceException extends Exception {
	 ...
	 */
	public ServiceException(String methodName, String message, String stack){
	 ...
	 * @param code codigo da excecao lancada
	 */
	public ServiceException(String message, Throwable throwable, String code) {
		super(throwable);
		this.message = message;
		this.code = code;
	}
	 ...
	 * @param code codigo da excecao lancada
	 */
	public ServiceException(String message, Exception exception, String code) {
		super(exception);
		this.message = message;
		this.code = code;
	}	
