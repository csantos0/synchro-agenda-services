package br.com.synchro.exception;
 ...
 * @version 1.0
 * 
 * Excecao a ser lancada nas classes persistentes
 */
public class DaoException extends Exception {
	 ...
	 */
	public DaoException(String methodName, String message, String stack){
	 ...
	 * @param code codigo da excecao lancada
	 */
	public DaoException(String message, Throwable throwable, String code) {
		super(throwable);
		this.message = message;
		this.code = code;
	}
	 ...
	 * @param code codigo da excecao lancada
	 */
	public DaoException(String message, Exception exception, String code) {
		super(exception);
		this.message = message;
		this.code = code;
	}	
